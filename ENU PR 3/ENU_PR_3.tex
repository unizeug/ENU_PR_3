...
\begin{quote}
    ...
    \begin{quote}
        ...
        liegt wahrscheinlich daran, dass die Trägerfrequenz sehr hoch ist und der Puls des Twinpulse-Generators mit \si{8}{ms}
        ähnlich breit ist wie eine Halbwelle des modulierten Signals.
