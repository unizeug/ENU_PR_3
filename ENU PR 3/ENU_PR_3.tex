...
\begin{quote}
	...
	\end{figure}
      ...
      \TODO{Thommy: kannst du die Grafiken noch mal hübsch machen? (ne fbox macht nen kästchen drum)}
        \begin{center}
        \begin{tabular}{ll}
...
\begin{quote}
    ...
    \begin{quote}
        ...
        \subsubsection{Trägerfrequenz $f_c$ \& Proportionalitätskonstante $K_{FM}$}
            ...
            \begin{quote}
                ...
                auf $K_{FM}$ kann man mit dem minimalen und M
    ...
    \begin{quote}
        ...
        liegt wahrscheinlich daran, dass die Trägerfrequenz sehr hoch ist und der Puls des Twinpulse-Generators mit \si{5}{\micro
        \seconds} ähnlich breit ist wie eine Halbwelle des modulierten Signals.
